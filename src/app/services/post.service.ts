  ...
  private readonly posts = signal<Post[]>([
    {
      ...
      theme: 'solaris',
      body: [
        { id: 'b-001', type: 'heading', level: 2, text: 'Why Signals?' },
        {
          id: 'b-002',
          type: 'paragraph',
        ...
        { id: 'b-005', type: 'heading', level: 2, text: 'Key Benefits' },
        {
          id: 'b-006',
          type: 'paragraph',
    ...
    },
    {
      ...
      theme: 'abyss',
      body: [
        { id: 'b-011', type: 'heading', level: 2, text: 'The Power of Perspective' },
        {
          id: 'b-012',
          type: 'paragraph',
        ...
        { id: 'b-014', type: 'heading', level: 2, text: 'Building a Tilt Effect' },
        {
          id: 'b-015',
          type: 'paragraph',
    ...
    },
    {
      ...
      theme: 'neon',
      body: [
        { id: 'b-018', type: 'heading', level: 2, text: 'The Problem with Markdown' },
        {
          id: 'b-019',
          type: 'paragraph',
        ...
        { id: 'b-024', type: 'heading', level: 2, text: 'Enter JSON Blocks' },
        {
          id: 'b-025',
          type: 'paragraph',
