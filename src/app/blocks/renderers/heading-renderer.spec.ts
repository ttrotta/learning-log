...
describe('HeadingRendererComponent', () => {
  ...
  it('should render h1 for level 1', () => {
    const { fixture } = setup({ id: 'b-test-h1', type: 'heading', level: 1, text: 'Title A' });
  ...
  it('should render h3 for level 3', () => {
    const { fixture } = setup({ id: 'b-test-h3', type: 'heading', level: 3, text: 'Sub Title' });
  ...
  it('should render h6 for level 6', () => {
    const { fixture } = setup({ id: 'b-test-h6', type: 'heading', level: 6, text: 'Deepest' });
